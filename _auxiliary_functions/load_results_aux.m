if strcmp(dgp_type_plot,'both')
    ...
    load(fullfile(load_folder, strcat('dfm_', 'g', '_', estimand_type, '_', sample_length, '_', shock_type)))
    results_g = results;
    results_g.target_irf = DF_model.target_irf;
    results_g.M = DF_model.M;
    clear results DF_model DFM_estimate dgp_type

    load(fullfile(load_folder, strcat('dfm_', 'mp', '_', estimand_type, '_', sample_length, '_', shock_type)))
    results_mp = results;
